...
public class SqlMonitorManager implements Interceptor {
    ...
    private static final Logger logger = LogManager.getLogger(SqlMonitorManager.class);
    ...
    private String getSql(Configuration configuration, BoundSql boundSql, String sqlId, String sqlCommandType, long time) {
